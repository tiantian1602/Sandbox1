...
# create a new list of integers using a list comprehension
...
# create a new list of numbers greater than 9 using a list comprehension
...
# create a string of last names for full names longer than 11 characters
